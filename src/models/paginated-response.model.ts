...
export async function parsePaginationFromUrl(searchParams: URLSearchParams): Promise<PaginationResponseParams> {
  const rawParams = {
  ...
  const paginationData = {
    ...
    pageSize: rawParams.pageSize ? Number(rawParams.pageSize) : 10,
  };
