...
const sampleVideos = [
  ...
  },
  {
    ...
    description: 'The first open-source animated film ever made. CC BY 2.5 — Blender Foundation.',
  ...
  },
  {
    ...
    description: "Extended director's cut of the award-winning open-source animation.",
    videoUrl: 'https://storage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4',
    genreNames: ['Movies'],
  },
  {
